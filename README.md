...
### To request money from another user, the user must enter both the username of the other user and the amount of money that they are requesting.   
...
### Users may also send money to another user.  Unlike requests, when sending money the transaction is automatically approved and processed.   
